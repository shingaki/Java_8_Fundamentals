// GradeBook2.java
// GradeBook2 class using a 2-diemsnional array to store test grades
...
public class GradeBook2
{
   ...
   public void processGrades()
   {
      ...
      System.out.printf("%n%s %d%n%s %d%n%n",
         ...
         "Highest grade in teh grade book is", getMaximum());
   ...
   public int getMinimum()
   {
      ...
      {
         // loop through contents of current row
   ...
   {
      // assume first element of grades in array is largest
      int highGrade = grades[0][0];

      // loop through rows of grades array
      for (int[] studentGrades : grades)
      {
         // loop through content of current row
         for (int grade : studentGrades)
         {
   ...
   public void outputBarChart()
   {
      ...
      // for each grade frequency, print bar in chawrt
