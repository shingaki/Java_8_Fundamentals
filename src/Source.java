...
public class Source
{
   // field that is acceptable to all methods of this class
   private static int x = 1;

   // method main creates and initializes local variable x
   // and calls methods variables and useField
   public static void main(String[] args)
   {
      ...
      useField(); // useField uses class Scope field x
      useLocalVariable(); // useLocalVariavle reinitializes local x
