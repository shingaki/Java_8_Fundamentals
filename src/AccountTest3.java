...
public class AccountTest3
{
   public static void main(String[] args)
   {
      ...
      //dispolay initial balance of each object
      ...
      double depositAmount = input.nextDouble(); // obtain user inpout
      ...
      depositAmount = input.nextDouble(); // obtain user inpout
