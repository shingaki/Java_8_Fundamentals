...
public class LetterGrades
{
   public static void main(String[] args)
   {
      ...
      int fCount = 0; // counter of E grades
      ...
      while (input.hasNext())
      {
         ...
         switch (grade / 10)
         {
            ...
            case 6: // grade was betwee 60 and 69
               ++dCount;
               break; // exits switch
      ...
      if (gradeCounter != 0)
      {
         ...
         System.out.printf("%n%s%n%s%d%n%s%d%n%s%d%n%s%d%n%s%d%n",
            "Number of students who received each rade:",
            "A: ", aCount,
            "B: ", bCount,
            "C: ", cCount,
            "D: ", dCount,
      ...
      else // no grades were entered, so output appropriate messagr
